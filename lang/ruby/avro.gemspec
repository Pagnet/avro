# -*- encoding: utf-8 -*-
# stub: avro 1.10.0.pre1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.test_files = ["test/test_schema_compatibility.rb".freeze, "test/test_schema_normalization.rb".freeze, "test/test_schema.rb".freeze, "test/test_logical_types.rb".freeze, "test/test_fingerprints.rb".freeze, "test/test_help.rb".freeze, "test/test_io.rb".freeze, "test/test_socket_transport.rb".freeze, "test/test_protocol.rb".freeze, "test/test_schema_validator.rb".freeze, "test/test_datafile.rb".freeze]
